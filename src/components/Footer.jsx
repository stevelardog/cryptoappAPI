...
<div className='rounded-div mt-8 pt-8'>
    ...
    <p className='text-center py-4'> Powered by Coin Gecko , Created by 
    <a className='text-blue-600' href='https://stevenlarsen.dev/' target='_blank' rel='noreferrer' > Steven Larsen</a></p>
</div>
